...
for (sn in SNnames){
	...
	# Get a list of the GAPE files in the appopriate data folder
	...
	write.csv(tempData, file = paste0(localpath,outputgapedir,sn,'.csv'),
			row.names=FALSE)
}


#ConcatGapeFiles(filenames,myTimeZone,code,startDate,endDate,verbose)
