...
* process raw heart data into beats per minute estimates, with
...
```{r importSalinityData,echo=showcode}
#############################################################
...
```{r testPlotTrial1,echo=showcode}
# Controls, Trial 1:  SN173, SN196, SN224
# Low salinity Trial 1: SN189, SN218, SN179  (SN103 no data)
...
```{r comboTrial1Plot, echo=showcode, dev = 'png',fig.width=12,fig.height=8,dpi=300,fig.cap='Trial 1'}
...
```{r comboTrial1ControlPlot, echo=showcode, dev = 'png',fig.width=12,fig.height=8,dpi=300,fig.cap='Trial 1'}
# Controls, Trial 1:  SN173, SN196, SN224
...
```{r comboTrial1LowSalinityPlot, echo=showcode, dev = 'png',fig.width=12,fig.height=8,dpi=300,fig.cap='Trial 1'}
# Low salinity Trial 1: SN189, SN218, SN179  (SN103 no data)
...
```{r bigGapeHeartSalinityPlot,echo=showcode, dev = 'png', fig.width=8,fig.height = 16, dpi = 300}
...
#legend('topleft',legend=c('Heart rate','Gape, mm'), col = c(2,4),
#		lty= c(1,1))
mtext(side = 3, text = 'Control 38PSU, SN173', line = -1.5, cex = 0.8, adj = myadj)
...
mtext(side = 3, text = 'Control 38PSU, SN196', line = -1.5, cex = 0.8, adj = myadj)
abline(v = c(declineStart, declineFinish,riseStart), lty = 3)
###########################################
...
#legend('topleft',legend=c('Heart rate','Gape, mm'), col = c(2,4),
#		lty= c(1,1))
mtext(side = 3, text = 'Control 38PSU, SN224', line = -1.5, cex = 0.8, adj = myadj)
...
#legend('topleft',legend=c('Heart rate','Gape, mm'), col = c(2,4),
#		lty= c(1,1))
mtext(side = 3, text = 'Low Salinity, SN189', line = -1.5, cex = 0.8, adj = myadj)
abline(v = c(declineStart, declineFinish,riseStart), lty = 3)
...
mtext(side = 3, text = 'Low Salinity, SN218', line = -1.5, cex = 0.8, adj = myadj)
abline(v = c(declineStart, declineFinish,riseStart), lty = 3)
###########################################
...
#legend('topleft',legend=c('Heart rate','Gape, mm'), col = c(2,4),
#		lty= c(1,1))
mtext(side = 3, text = 'Low Salinity, SN179', line = -1.5, cex = 0.8, adj = myadj)
